...
export function RequestAccessModal({
	...
	return createPortal(
		<div className="fixed inset-0 z-50">
			...
			/>
			<div
				className="fixed inset-0 flex max-h-[100dvh] items-start justify-center overflow-y-auto overscroll-contain px-6 py-6 touch-pan-y sm:items-center sm:px-8 sm:py-12"
